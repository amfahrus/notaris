<div class="container">
	...
	<div class="panel panel-default">	
		...
		<?php if ($query === 'search'): ?>
   			<a href="<?php echo base_url().'Home/ambil_klien_berkas_pending/'.$id_berkas.'/'.$tipe;?>"><span class="glyphicon glyphicon-menu-left"></span>Kembali ke tampilan semua</a>    		
    	<?php else: ?>
		...
		<div class="panel-body">
        	...
        	<form action="<?php echo base_url().'Home/ambil_klien_berkas_pending/'.$id_berkas.'/'.$tipe;?>" method="post" accept-charset="utf-8">
			        ...
			        foreach ($list as $klien): 
			        	...
			        	?>	
			        		<div class="list-group-item" >
					            ...
					            <a href="#" data-toggle="modal" data-target=".menu" data-jenis="ambil_berkas_pending" data-tipe="<?php echo $tipe;?>" data-berkas="<?php echo $id_berkas;?>" data-id="<?php echo $klien->id_pemohon;?>">
			...
			<div class="modal-dialog modal-sm">
			  <div class="modal-content">
			    ...
			    <div class="modal-body">
			      <ul class="list-group">
			        <a id="ambil_klien_berkas_pending" href="#" class="list-group-item"><span class="glyphicon glyphicon-edit "></span>  Ambil Data</a>
			      </ul>
			    </div>
			  </div>
			</div>
